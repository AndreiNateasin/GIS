...
namespace GIS.Domain.Model
{
    ...
    public partial class NetworkOperators
    {
        public NetworkOperators()
        {
            this.ElectricalTariffs = new HashSet<ElectricalTariffs>();
        ...
        public virtual ICollection<ElectricalTariffs> ElectricalTariffs { get; set; }
